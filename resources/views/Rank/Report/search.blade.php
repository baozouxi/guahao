...
<div class="guide">
    <ul class="left">
        ...
        {!! guideHtml('竞价报表', route('rankReport')) !!}
    </ul>
</div>
    ...
    <div id="container" class="container">
        ...
        <div class="fun block" id="fun">
            ...
            <select class="select" onchange="To('/rank/report/searchByMonth?month='+this.options[this.selectedIndex].value+'','main');">
                ...
                @if($month->rank_date == $current_month)
                    <option value="{{ $month->rank_date }}" selected="selected">{{ $month->rank_date }}月</option>
                @else
                    <option value="{{ $month->rank_date }}">{{ $month->rank_date }}月</option>
                @endif
                @endforeach
            </select>
            <select class="select" onchange="To('/rank/report/searchByMonth?month={{ $current_month }}&way='+this.options[this.selectedIndex].value,'main');">
