        ...
        <div id="box" class="box">
            <table cellspacing="1" cellpadding="0">
                ...
                @endif
                        ...
                        <span class="icon">Ĵ</span> 
                         @if(check_node('consult_edit'))
                        <a href="javascript:void(0);" onclick="fastH(this,'main')" url="{{ route('consult.edit',['id'=>$item['id']]) }}"><i>{{ $item['name'] }}</i></a>
                        @else
                            <i>{{ $item['name'] }}</i>
                        @endif
                        </td>
