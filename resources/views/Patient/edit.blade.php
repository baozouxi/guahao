    ...
    <div id="wrap" class="wrap">
        ...
        <div id="container" class="container">
            <div class="top">
                <h3 class="left"><span class="icon">Ą</span>编辑患者</h3>
            ...
            <div id="box" class="box">
                <form id="form_sub" name="form_sub" method="post" action="javascript:fastP('{{ route('patient.update',['id'=>$data->id]) }}');">
                    ...
                    <input type="text" name="name" id="name" class="input" value="{{ $data->name }}" style="width:95px;" autocomplete="off" disableautocomplete="" onblur="this.style.backgroundColor='#fff';" onfocus="this.style.backgroundColor='#FFFEF1';this.style.backgroundImage='none';">
                    <input type="text" name="age" id="age" class="input" value="{{ $data->age }}" style="width:35px;" autocomplete="off" disableautocomplete="" onblur="this.style.backgroundColor='#fff';" onfocus="this.style.backgroundColor='#FFFEF1';">
                    ...
                    $('name').onchange = function() {
                        check('/callback/check/Patient/name/'+this.value, 'name', 8);
                        this.style.backgroundColor = '#fff';
                    }
                    </script>
                    <label class="inline">手机号码：<span id="phone_city" style="color:#19A97B;">重庆(023)-联通GSM</span></label>
                    <input type="text" name="phone" id="phone" class="input" value="{{ $data->phone }}" style="width:195px;" autocomplete="off" disableautocomplete="" onblur="this.style.backgroundColor='#fff';" onfocus="this.style.backgroundColor='#FFFEF1';this.style.backgroundImage='none';">
                    <script>
                    $('phone').onchange = function() {
                        if(!check_phone()) return;
                        check('/callback/check/patient/phone/'+this.value , 'phone', 8);
                        this.style.backgroundColor = '#fff';
                    }
                    </script>
                    <label class="inline">病历号：</label>
                    <input type="text" name="bid" id="bid" class="input" value="{{ $data->medical_num }}" style="width:195px;" autocomplete="off" disableautocomplete="" onblur="this.style.backgroundColor='#fff';" onfocus="this.style.backgroundColor='#FFFEF1';">
                    ...
                    <select class="select" name="dep" id="dep" style="width:205px;">
                        <option value="6" selected="selected">赵中献</option>
                    ...
                    <select class="select" name="ads" id="ads" style="width:205px;">
                        <option value="2" selected="selected">电视广告</option>
                ...
                <input type="hidden" name="this_url" id="this_url" value="/turn.asp?act=add&amp;id=8&amp;m=turn">
            </div>
        </div>
    </div>
