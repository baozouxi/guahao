...
class ReportController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Rank.Report.index',
            ['records' => $records, 'total' => $total, 'rank_ways' => $rank_ways, 'months' => $months]);
    }
    ...
    private function reduceArr($records)
    {
        ...
        $apps      = Appointment::whereBetween('add_time', [$dateStart, $dateEnd])->get([
            'id',
            'is_hospital',
            'add_time'
        ])->toArray();
    ...
    public function searchByMonth(Request $req)
    {
        ...
        return view('Rank.Report.search', [
            'records'       => $records,
            'total'         => $total,
            'rank_ways'     => $rank_ways,
            'months'        => $months,
