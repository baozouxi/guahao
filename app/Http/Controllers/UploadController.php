...
class UploadController extends Controller
{
    ...
    public function upload(Request $req)
    {
        ...
        if ($file->isValid()) {
            ...
            if ( ! in_array(strtoupper($extension), $this->getAllowExt())) {
                return "<script>window.parent.$('uploadstate').innerHTML='<b>错误：</b><hr>文件类型不被允许：<i>" . $originName . "</i><br>如果是文本请直接粘贴到聊天记录框即可！';</script>";
            }
